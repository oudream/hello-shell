...
git config --global https.proxy https://192.168.1.12:7890
git config --global --unset http.proxy
git config --global --unset https.proxy

npm config set registry http://registry.npm.taobao.org

http_proxy="http://10.31.58.78:7890/"
https_proxy="https://10.31.58.78:7890/"
...
alias go='http_proxy=http://192.168.91.253:7890/ https_proxy=http://192.168.91.253:7890/ go'
export https_proxy=http://192.168.91.253:7890/
export http_proxy=http://192.168.91.253:7890/
export GO111MODULE=off
# 没有试的
