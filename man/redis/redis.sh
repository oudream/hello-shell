...
# https://blog.csdn.net/qq_38002009/article/details/100018925
# 以一次需要先安装 core，然后再安装其他 app
snap download core
snap download redis-desktop-manager
snap download gnome
gnome-3-28-1804
#
snap ack core_7396.assert
sudo snap install core_7396.snap
#
snap ack gnome-3-28-1804_145.assert
sudo snap install gnome-3-28-1804_145.snap
#
snap ack redis-desktop-manager_531.assert
sudo snap install redis-desktop-manager_531.snap
#
snap list
