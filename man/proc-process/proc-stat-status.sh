...
awk '{print "CPU time: " $14+$15; print "start time: " $22}' stat
clk_tck=$(getconf CLK_TCK)
$starttime / $clk_tck
# https://man7.org/linux/man-pages/man5/proc.5.html
# https://stackoverflow.com/questions/39066998/what-are-the-meaning-of-values-at-proc-pid-stat
# https://blog.csdn.net/zhizhengguan/article/details/112200780
/proc/[pid]/stat
...
# https://stackoverflow.com/questions/14472073/calculate-clocks-per-sec
# In order to get the correct ticks per second on Linux, you need to use the return value of
# ::sysconf(_SC_CLK_TCK) (declared in the header unistd.h), rather than the macro CLOCKS_PER_SEC.
# The latter is a constant defined in the POSIX standard – it is unrelated to the actual ticks per second of your CPU clock.
# For example, see the man page for clock:
